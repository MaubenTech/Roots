      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl text-[#5D4E37] mb-8 leading-relaxed">
            This Corporate Cocktail & Fundraiser Evening is an exclusive, invitation-only event for selected partners,
            stakeholders, and supporters of MaubenTech Roots.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-[#5D4E37]">
              An evening of elegance with carefully curated experiences for our valued community
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#5D4E37]">
              Intimate gathering ensuring meaningful connections and impactful conversations
            </p>
          </motion.div>
        ...
        >
          ...
          <p className="text-lg mb-6 opacity-90">
            Stay connected with MaubenTech to learn about upcoming events and opportunities to support our mission of
