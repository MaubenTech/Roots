						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
							<div className="md:col-span-2 lg:col-start-2 lg:col-span-2">
								<div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
									...
									<h3 className="text-xl font-semibold text-[#2C3E2D] mb-2 text-center">
										Guest Policy
									</h3>
									<p className="text-[#5D4E37] text-lg leading-relaxed text-center">
										Maximum 1 guest per attendee
									</p>
								</div>
							</div>
						</div>
