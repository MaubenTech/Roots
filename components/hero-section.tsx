    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-4xl mx-auto text-center">
        <motion.div
          ...
          className="mb-8"
        >
          <Image src="/images/logo.png" alt="MaubenTech Roots Logo" width={200} height={200} className="mx-auto mb-8" />
        </motion.div>
        ...
        >
          Join Us for an Evening of <span className="text-[#B8860B]">Elegance</span>,{" "}
          <span className="text-[#6B8E23]">Impact</span> & <span className="text-[#2C3E2D]">Innovation</span>
        </motion.h1>
