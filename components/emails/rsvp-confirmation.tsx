				...
				<Container
					...
					<Section
						...
						<Section
							...
							<Img
								src="roots.maubentech.com/images/logo.png"
						...
						<Text
							...
							Oladipo Diya St, Durumi 900103, Abuja by
							Smokey house
						</Text>
						<Text
							style={{
						...
						<Text
							...
							We look forward to seeing you at this exclusive
							evening of elegance, connection, and impact!
						</Text>
						...
						<Text
							...
							<Link
								href="mailto:info@maubentech.com"
								style={{ color: "#6B8E23" }}>
								info@maubentech.com
							</Link>
						</Text>
