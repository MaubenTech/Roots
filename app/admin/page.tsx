...
import { Eye, EyeOff, Lock, Trash2, Edit, MoreHorizontal, Download, TestTube, Mail } from 'lucide-react'
      ...
      <Dialog open={emailDialogOpen} onOpenChange={setEmailDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Send an email to {emailRSVP?.full_name} ({emailRSVP?.email})</DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                isSendingEmail ||
                !emailType ||
                (emailType === "custom" && (!customSubject || !customMessage))
              }
              className="bg-[#6B8E23] hover:bg-[#5A7A1F]"
            >
